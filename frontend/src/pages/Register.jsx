...
const styles = {
  container: {
    ...
    alignItems: 'center',
    background: 'linear-gradient(135deg, #D896D8 0%, #A8C5E6 25%, #6BBBDB 50%, #6B8FBF 75%, #9B6B9E 100%)',
    padding: '20px'
  },
  card: {
  ...
  title: {
    textAlign: 'center',
    background: 'linear-gradient(135deg, #D896D8 0%, #6BBBDB 50%, #9B6B9E 100%)',
  ...
  transition: '0.3s',
  fontWeight: 'bold',
  boxShadow: '0 6px 20px rgba(155, 107, 158, 0.5)',
